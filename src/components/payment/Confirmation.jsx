        ...
        <Row gutter={24}>
          <Col span={18}>
            <Card className="card-summary">
              ...
              <Row gutter={16}>
                ...
                <Col span={10}>
                  <p>
                    <span>Điện thoại 1</span><br />
                    <span>Điện thoại 2</span>
                  </p>
                </Col>
                <Col span={4}>
                  <p>
                    <span>1,000,000vnd</span><br />
          ...
          <Col span={6} className="summary">
            ...
            <Link to="/payment/complete">
              <Button type="primary" className="btn-confirm" onClick={next}>Xác nhận</Button>
            </Link>
            <Link to="/payment/select-method">
              <Button type="secondary" className="btn-confirm mt-24" onClick={back}>Quay lại</Button>
            </Link>
          </Col>
        </Row>
      </div>
